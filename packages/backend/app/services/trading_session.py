...
class TradingSessionService:
    ...
    async def stop_session(
        ...
        if portfolio:
            ...
            trading_session.total_pnl = portfolio.current_capital - trading_session.starting_capital
    ...
    def get_execution_service(self, session_id: int) -> Optional[ExecutionService]:
    ...
    def get_risk_management_service(self, session_id: int) -> Optional[RiskManagementService]:
