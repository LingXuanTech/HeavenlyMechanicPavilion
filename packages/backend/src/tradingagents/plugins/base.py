...
class DataVendorPlugin(ABC):
    ...
    def get_stock_data(
        ...
        raise NotImplementedError(
            f"{self.name} does not support stock data retrieval"
        )
    ...
    def get_indicators(
        ...
        """
        raise NotImplementedError(
            f"{self.name} does not support technical indicators"
        )
    ...
    def get_fundamentals(self, ticker: str, curr_date: str) -> str:
        ...
        """
        raise NotImplementedError(
            f"{self.name} does not support fundamental data retrieval"
        )
    ...
    def get_balance_sheet(
        ...
        """
        raise NotImplementedError(
            f"{self.name} does not support balance sheet retrieval"
        )
    ...
    def get_cashflow(
        ...
        """
        raise NotImplementedError(
            f"{self.name} does not support cash flow retrieval"
        )
    ...
    def get_income_statement(
        ...
        """
        raise NotImplementedError(
            f"{self.name} does not support income statement retrieval"
        )
    ...
    def get_news(
        ...
        """
        raise NotImplementedError(
            f"{self.name} does not support news retrieval"
        )
    ...
    def get_global_news(self, limit: int = 10) -> str:
        ...
        """
        raise NotImplementedError(
            f"{self.name} does not support global news retrieval"
        )
    ...
    def get_insider_sentiment(self, symbol: str) -> str:
        ...
        """
        raise NotImplementedError(
            f"{self.name} does not support insider sentiment retrieval"
        )
    ...
    def get_insider_transactions(self, ticker: str) -> str:
        ...
        """
        raise NotImplementedError(
            f"{self.name} does not support insider transactions retrieval"
        )
