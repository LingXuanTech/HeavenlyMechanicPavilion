...
class ResearchManagerPlugin(AgentPlugin):
    """Research manager agent for facilitating investment debates and making decisions."""
    ...
    def capabilities(self) -> List[AgentCapability]:
        return [AgentCapability.INVESTMENT_MANAGEMENT]
...
{history}"""
    ...
    def description(self) -> str:
        return "Research manager facilitating investment decisions"
    ...
    def create_node(
        ...
        **kwargs
        ...
        """Create the research manager node function."""
