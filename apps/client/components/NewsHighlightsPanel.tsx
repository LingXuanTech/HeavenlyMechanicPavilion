...
const NewsHighlightsPanel: React.FC<NewsHighlightsPanelProps> = ({ className = '' }) => {
  ...
  return (
    <div
      className={`bg-surface-raised/50 border border-border rounded-xl overflow-hidden ${className}`}
    >
      {/* Header */}
      ...
      <div className="divide-y divide-border/50">
        {isLoading ? (
          ...
          <div className="py-10 text-center text-stone-500 text-xs">暂无新闻</div>
        ) : (
