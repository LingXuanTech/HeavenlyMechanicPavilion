    ...
    <div className="flex-1 min-w-[180px] space-y-3">
      ...
      {report?.debate && (
        <div className="text-center">
          <div className="text-[10px] text-gray-500 mb-1">辩论赢家</div>
          <span
    ...
    <div className="border border-gray-800 rounded-lg overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-300 font-medium">历史分析对比</span>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-gray-500">选择要对比的分析（最多 3 个）</span>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-gray-600 font-mono">{item.confidence}%</span>
                    </div>
                  </button>
                );
              })}
          ...
          {canCompare && loadedDetails.length >= 2 && !isLoading && (
            <div className="border-t border-gray-800 pt-4">
              <h4 className="text-xs text-gray-500 uppercase tracking-wider mb-3">对比详情</h4>
